...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if (strlen($username) < 3 || strlen($username) > 20) {
		$registerError = 'Username must be between 3 and 20 characters.';
	...
	<main class="main-pane">
		...
		<section class="content-grid">
			<form class="form-panel two-col" action="register.php" method="post">
				...
				<?php endif; ?>
				<div class="form-grid">
					<label class="field full-col">Username<input type="text" name="username" required minlength="3" maxlength="20" pattern="^[a-zA-Z0-9_]+$" title="Only letters, numbers, and underscores allowed."></label>
