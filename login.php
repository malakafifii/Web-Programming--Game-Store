	...
	<main class="main-pane">
		...
		<section class="content-grid">
			<form class="form-panel two-col" action="login.php" method="post">
				...
				<?php endif; ?>
				<div class="form-grid">
					<label class="field full-col">Username<input type="text" name="username" placeholder="admin" required></label>
					<label class="field full-col">Password<input type="password" name="password" placeholder="admin" required></label>
				</div>
