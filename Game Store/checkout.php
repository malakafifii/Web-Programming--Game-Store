		...
		<section class="content-grid">
			...
			<form class="form-panel two-col" action="checkout.php" method="post">
				...
				<div class="form-grid">
					...
					<label class="field">Phone<input type="tel" name="phone" placeholder="(555) 555-5555" required></label>
					<label class="field">Email<input type="email" name="email" placeholder="you@example.com" required></label>
